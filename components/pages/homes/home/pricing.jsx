                ...
                <div className="row mb-50">
                    <div className="col-xl-12">
                        <div className="price__area-title t-center">
                            <span className="subtitle wow fadeInLeft" data-wow-delay=".4s">Service Packages</span>
                            <h2 className="wow fadeInRight" data-wow-delay=".6s">Flexible Solutions for Every Project</h2>                        
                        </div>
                    </div>
                </div>
                <div className="row">
